...
module.exports.JsEngine = nativeBinding.JsEngine
module.exports.NativeEar = nativeBinding.NativeEar
module.exports.bash = nativeBinding.bash
...
module.exports.kept = nativeBinding.kept
module.exports.onConsoleEnd = nativeBinding.onConsoleEnd
module.exports.shell = nativeBinding.shell
