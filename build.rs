...
enum Kind {
  ...
  Float,
  Bool,
  /// Any value of the engine, a callable among them: a show of the engine, or a function of the host.
  Object,
  Text,
  Strs,
...
impl Kind {
  fn of(annotation: &str) -> Kind {
    match annotation {
      ...
      "bool" => Kind::Bool,
      "object" | "type[T] | object" | "Show" | "Filter" => Kind::Object,
      "Text" => Kind::Text,
      "list[str]" => Kind::Strs,
  ...
  fn field(self) -> &'static str {
    match self {
      ...
      Kind::Object | Kind::MaybeCallable => "Option<Object>",
  ...
  fn script(self) -> &'static str {
    match self {
      ...
      Kind::Bool => "boolean",
      Kind::Object | Kind::MaybeCallable => "unknown",
      Kind::Text => "TextValue",
      Kind::Strs => "string[]",
